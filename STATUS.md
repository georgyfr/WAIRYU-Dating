...
| Facebook Login | ✅ **Actif** (2026-09-23) | Secrets posés prod+staging ; `/start` 302 validé (dialogue v21.0, client_id + redirect_uri + scope corrects) ; callback Data Deletion testé avec signed_request conforme Meta : contrat respecté (200 + url + confirmation_code) |
